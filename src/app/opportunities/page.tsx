              ...
              <div className="space-y-6">
                    ...
                    <div className="space-y-4 pt-4">
                      <div className="flex gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">Based on your profile, this aligns with your expertise in AI.</p>
                        </div>
                      </div>
                      ...
                      <div className="flex gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">Explore similar grants in AI and technology.</p>
                        </div>
                      </div>
                      ...
                      <div className="flex gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">Analyze funding trends and success rates.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-background-light dark:bg-background-dark/50 p-6 rounded-xl border border-gray-200/20 dark:border-gray-800/30">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-xs text-gray-600 dark:text-gray-400">Attribution: AI Grant Foundation</p>
